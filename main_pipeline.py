...
from alert import send_alert  # ALERT SYSTEM INTEGRATION
...
prev_frame = None
alert_triggered = False  # To avoid repeat alerts
...
while True:
    ...
    risk_level = calculate_risk_score(
        ...
        num_people=num_people  # new argument
    )
    ...
    if risk_level == "High":
        ...
        alert_triggered = False  # Reset if risk subsides
